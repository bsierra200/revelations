...
class CjfSearcher
{
     ...
     * @return CjfSearcher
     */
    public function setElasticSearchClient(Client $elasticSearchClient): CjfSearcher
    {
     ...
     * @return CjfSearcher
     */
    public function setIndexName(string $indexName): CjfSearcher
    {
     ...
     * @return CjfSearcher
     */
    public function setDocType(string $docType): CjfSearcher
    {
